...
const RoomDetails = () => {
    ...
    const checkAvailability = async () => {
        try {
            ...
            console.log("check-availability data :-", data);
    ...
    useEffect(() => {
        console.log("✅ isAvailable changed to:", isAvailable);
    }, [isAvailable]);
    ...
    return room && (
        <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
                    ...
                    <div className="flex flex-wrap items-center mt-3 mb-6 gap-4">
                        {
                            room.amenities.map((item, index) => (
                                <div key={index} className="flex items-center gap-2 px-3 py-2 rounded-l-lg bg-gray-100">
            ...
            <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500">
                <p>Guest will be allocated to ground floor according to availability.
                    You get a comfortable two bedroom apartment has a true city feeling.
                    The price quoted is for two guest, at the gust slot please the mark number of
                    guest to get exact price for groups. The Guests wil be allocated
