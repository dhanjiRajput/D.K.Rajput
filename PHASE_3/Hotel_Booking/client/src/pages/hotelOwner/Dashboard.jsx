...
const Dashboard = () => {
  ...
  return (
    <div>
        <Title title='Dashboard' align='left' font='outfit' subTitle='Monitor your room listings, 
        track bookings analyze revenue-all in one place. stay updated  with real-time insights
