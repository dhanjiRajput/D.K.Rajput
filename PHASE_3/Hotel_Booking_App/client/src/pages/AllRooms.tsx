...
const RadioButton = ({ label, selected = false, onChange = () => {} }: RadioButtonProps) => {
  return (
    <label className="flex gap-3 items-center cursor-pointer mt-2 text-sm">
      <input
        type="radio"
...
const AllRooms = () => {
  ...
  const roomTypes: string[] = ['Single Bed', 'Double Bed', 'Luxury Room', 'Family Suite'];
  const priceRanges: string[] = ['0 to 500', '500 to 1000', '1000 to 2000', '2000 to 3000'];
  const sortOptions: string[] = ['Price Low to High', 'Price High to Low', 'Newest First'];
  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32">
      ...
      <div>
        ...
        {roomsDummyData.map((room: RoomType) => (
          <div
            key={room._id}
