...
const Addroom = () => {
  ...
  return (
    <form>
        <Title title='Add Room' align='left' font='outfit' subTitle='Fill in the details carefully and accurate room details, pricing,
        ...
        <div className="flex flex-col flex-wrap mt-1 text-gray-400 max-w-sm">
            {
                Object.keys(inputs.amenities).map((amenity,index)=>(
                    <div key={index}>
                        <input type="checkbox" id={`amenties${index+1}`} checked={inputs.amenities[amenity]} 
