  ...
  return (
    <div className='h-screen relative overflow-hidden'>
      ...
      <div className='flex flex-col justify-end absolute h-screen top-0 w-full'>
        <div className='h-[30%] bg-white p-5 rounded-t-xl relative'>
          ...
          <form onSubmit={onSubmitHandler}>
            ...
            <input onClick={() => setPanelOpen(true)} value={pickup} onChange={(e) => setPickup(e.target.value)} className='bg-[#eee] px-12 py-2 text-lg rounded-lg w-full mt-5' type="text" placeholder='Pickup Location' />
            <input onClick={() => setPanelOpen(true)} value={destination} onChange={(e) => setDestination(e.target.value)} className='bg-[#eee] px-12 py-2 text-lg rounded-lg w-full mt-3' type="text" placeholder='Destination Location' />
          </form>
        </div>
