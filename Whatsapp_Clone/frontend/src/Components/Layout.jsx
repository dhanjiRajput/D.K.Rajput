...

            {
                isThemeDialogOpen && (
                    <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50'>
                        <div className={`${theme === 'dark' ? 'bg-[#202c33] text-white' : 'bg-white text-black'} p-4 rounded-lg shadow-lg max-w-sm w-full`}>
                            <h2 className='text-2xl font-semibold mb-4'>
                                Choose a Theme
                            </h2>
                        
                            <div className='space-y-4'>
                                <label htmlFor="" className='flex items-center cursor-pointer space-x-3'>
